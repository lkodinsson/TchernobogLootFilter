function hideItems(data)
	...
	if itemColor == COLOR_WHITE and isEquipment(data) and alwaysShowNormal == false then return TRUE end
	if itemColor == COLOR_BLUE and isEquipment(data) and alwaysShowMagic == false then return TRUE end
	if itemColor == COLOR_YELLOW and isEquipment(data) and alwaysShowRare == false then return TRUE end
